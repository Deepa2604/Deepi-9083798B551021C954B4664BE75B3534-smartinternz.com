...
cannot be accessed directly from outside the class. Write program to create an instance of the
...
class BankAccount:
 ...
 def deposit(self, amount):
  if amount > 0:
   ...
   print("Invalid deposit amount. Please deposite postive amount.")
